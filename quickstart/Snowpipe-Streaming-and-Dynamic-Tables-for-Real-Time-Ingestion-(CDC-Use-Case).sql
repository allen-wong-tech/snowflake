/*
Quickstart: Snowpipe Streaming and Dynamic Tables for Real-Time Ingestion (CDC Use Case)

https://quickstarts.snowflake.com/guide/CDC_SnowpipeStreaming_DynamicTables/index.html?index=..%2F..index#1
...
alter user vhol_streaming1 set rsa_public_key='
<REPLACE ME>
';
...
SELECT count(*) FROM LIMIT_ORDERS_CURRENT_DT;  --472459
...
select  count(*) from LIMIT_ORDERS_SCD_DT;--1000344
...
--Invalid object type 'DYNAMIC_TABLE' for privilege 'REFERENCES'.
...
--(Optional Cleanup Steps c,d,e,f)
/*
